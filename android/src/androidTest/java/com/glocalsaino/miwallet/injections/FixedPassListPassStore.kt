package com.glocalsaino.miwallet.injections
...
import com.glocalsaino.miwallet.model.PassStoreUpdateEvent
...
class FixedPassListPassStore(private var passes: List<Pass>) : PassStore {
    ...
    override fun allPasses(): List<Pass> = passMap.values.toList()
