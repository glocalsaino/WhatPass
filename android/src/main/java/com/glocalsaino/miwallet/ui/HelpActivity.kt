...
import com.glocalsaino.miwallet.databinding.ActivityHelpBinding
...
class HelpActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val html = HtmlCompat.fromHtml(getString(R.string.help_content), HtmlCompat.FROM_HTML_MODE_LEGACY, null, ListTagHandler())
