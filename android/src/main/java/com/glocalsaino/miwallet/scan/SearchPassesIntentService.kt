package com.glocalsaino.miwallet.scan
...
import com.glocalsaino.miwallet.model.PastLocationsStore
import com.glocalsaino.miwallet.model.pass.Pass
import com.glocalsaino.miwallet.scan.events.DirectoryProcessed
import com.glocalsaino.miwallet.scan.events.PassScanEventChannelProvider
import com.glocalsaino.miwallet.scan.events.ScanFinished
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        lifecycleScope.launch {
            ...
            if (Build.VERSION.SDK_INT > 25) {
                ...
                val channel = NotificationChannel(NOTIFICATION_CHANNEL_ID, "WhatPass Pass scan", NotificationManager.IMPORTANCE_DEFAULT)
                channel.description = "Notifications when WhatPass is scanning for passes"
